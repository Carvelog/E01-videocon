...
UserRoutes.get('/users/:cuid', [ RoleRequired('admin'), cuidValidator ], UserController.getUser);

// Add a new user
UserRoutes.post('/users', [ RoleRequired('admin'), registerUserValidator ], UserController.registerUser);
